...
const OnboardingPage = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-base-100 flex items-start sm:items-center justify-center p-4 py-8 sm:py-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              ...
              <div className="flex gap-6 px-1">
                <label className="label cursor-pointer flex gap-2 p-0">
                  <input
                    type="radio"
                    name="gender"
